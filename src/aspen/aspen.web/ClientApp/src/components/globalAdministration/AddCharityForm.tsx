...
interface AddCharityFormProps extends RouteComponentProps<MyRouteProps> {
    Charity?: Charity,
    adminAddCharity: typeof actionCreators.adminAddCharity,
}

const AddCharityForm:React.FC<AddCharityFormProps> = props => {
